...
const RHYMES = {
    ...
    3: "Der hvor maven får sin lykke — findes spor i køkken (2 etage).",
    ...
    9: "Grønt ved gryder, tæt ved mad — ved planten ved køkkenet i (7C etage).",
    ...
    12: "Ping og pong — find næste ved bordtennisbordet (kantine).",
    13: "Sortér med stil ved affald — ved stolpens hjørne står næste kald (kantine).",
    14: "Blødt og lyst i — under vindueskarmen kan du se (8B etage).",
    15: "Inde i boksen er der fred — måske ovenpå gemmer det (8B etage).",
    16: "Kaffe og mad lokker — tjek i skålen eller under bordet i køkkenet (8B etage).",
    17: "Hvor sider vendes, viden glad — i køkkenhjørnet ved bladene (8C etage).",
    18: "Der hvor papir bor — masser af IT (8C etage).",
    19: "Hængende i bagerste lokale — masser af skærme stående (8C etage).",
    20: "Op i ni'eren hvor ekko gør — ved forum-røret (9 etage).",
    21: "Se hvad skærmen si'r — i rummet med kaffe og mad (6B etage).",
    22: "Planer ruller fri - måske der også er en spilleaften (6B etage).",
    23: "Glimt og glimmer, lys og sjov — ved diskokuglen (6B etage).",
